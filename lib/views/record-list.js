define(["jquery",
        ...
        "marionette",
        "collection",
        "views/authentication-mixin",
        "handlebars",
        "handlebars-helpers"
    ],
    function ($, _, Marionette, Collection, AuthenticationMixin, Handlebars) {
        'use strict';
        /**
        ...
        var RecordList = Marionette.View.extend({
            ...
            initCollection: function () {
            	this.collection = new Collection({
                    ...
                    dataType: this.opts.data_type || "json",
            ...
            loadTemplateFromFile: function () {
            	var path = 'templates/' + this.template_path  + '?rand' + Math.random(),
                    that = this;
                $.ajax({
                    url: path,
                    dataType: "text",
            ...
            renderWithHelpers: function () {
            	...
            	console.log("render with helpers!", this.templateHelpers);
            ...
            newPage: function (e) {
                var that = this;
                console.log("NEW PAGE!!!!", $(e.target).attr('page-num'));
        ...
        _.extend(RecordList.prototype, AuthenticationMixin);
        return RecordList;
    });