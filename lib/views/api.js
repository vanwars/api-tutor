        ...
        var APIView = RecordList.extend({
        	events: function(){
  			...
  			initialize: function (opts) {
                ...
                this.globals.vent.on("template-updated", function () {
                	console.log(that.getTemplateTextFromCache(that.template_path), 
				  		that.template_path
			  		);
				  	that.loadChildTemplate(
				  		that.getTemplateTextFromCache(that.template_path), 
				  		that.template_path
			  		);
				});
            },
            ...
            routeToUserTemplate: function (e) {
            	var that = this;
            	this.template_path = "templates/" + this.$el.find("select").val();
