        ...
        var APIView = RecordList.extend({
            ...
            checkCredentials: function () {
  			...
  			search: function (e) {
  				...
  				console.log(this.collection.query_params)
            ...
            routeToUserTemplate: function (e) {
            	...
            	this.loadTemplateFromFile(function (template_text) {
        			//this callback loads template w/o re-querying
            		that.template = Handlebars.compile(template_text);
            		that.render();
            		that.globals.vent.trigger("template-loaded", {
